                  ...
                  fluidRow(
                    column(6,
                           box(width = NULL,
                               ...
                               in decresing order.",
                               br(), br(),
                               strong("Level 1"), "- species name is determined by a specialist in the biological group, if not;", br(),
                               strong("Level 2"), "- taxonomist's name is provided, if not;", br(),
                               strong("Level 3"), "- occurrence has an associated image, if not;", br(),
                               strong("Level 4"), "- specimen is part of a scientific collection, if not;", br(),
                               strong("Level 5"), "- occurence is determined in field observation, if not;", br(),
                               strong("Level 6"), "- no previous criteria are met.", br(), br(),
